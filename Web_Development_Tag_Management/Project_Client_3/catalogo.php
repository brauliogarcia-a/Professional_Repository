...
$cantidad = $productoDAO->getCantidadCategorias();
...
if( $cantidad[0]['cantidad'] > 0 ) // Si la cantidad es mayor a cero
    $categs = $productoDAO->getPaginacionCategorias( (int) $GLOBALS['inicio'], (int) TAMANIO ); 
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
     ...
     <header>
        ...
        <div class="banner">      
            <div class="ContainerTextoBanner"><div class="TextoBanner">Catálogo</div></div>
            <div class="line"></div>
        ...
        <div class="linkAzul">
            <li><a href="index.php">Inicio</a></li>
            <li><a href="catalogo.php">Cat&oacute;logo</a></li>
        </div>
        ...
        <div>
            ...
            <?php
                if(isset($categs)){
                    if($categs != NULL){
                        foreach ($categs as $valor) {  
            ?>
                <div class="modelo">
                    <a href="<?php echo 'productosporcategoria.php?criterio='.$valor['id']; ?>">
                        <img src="<?php echo $valor['imagen']; ?>" class="modeloI">
                    </a>                    
                    <div class="modeloLink">
                        <a href="<?php echo 'productosporcategoria.php?criterio='.$valor['id']; ?>"><?php echo $valor['nom']; ?></a>
                    </div>
                </div>
            <?php
                        }
                    } else
                        echo '<h1>Lo sentimos</h1><p>No hay categor&iacute;as.</p>';
                } else
                    echo '<h1>Lo sentimos</h1><p>No hay categor&iacute;as.</p>';
            ?>
            </div>
            ...
            <div id="pagina">
                ...
                ?>
                                <li>
                                    <a href="catalogo.php?pagina=<?php echo $i; ?>#ancla">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                <?php 
                ...
                ?>      
                                <li class="next">
                                    <a href="catalogo.php?pagina=<?php echo $numeropaginas; ?>#ancla">
                                        Next &raquo;
                                    </a>
                                </li>
                <?php
                ...
                ?>
                            <li class="previous">
                                <a href="catalogo.php?pagina=<?php echo $prevpag; ?>#ancla">
                                    &laquo; Previous
                                </a>
                            </li>
                <?php
                ...
                ?>   
                                <li class="next">
                                    <a href="catalogo.php?pagina=<?php echo $nextpag; ?>#ancla">
                                        Next &raquo;
                                    </a>
                                </li>
                <?php
