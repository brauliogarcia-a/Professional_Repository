...
if( isset( $_GET['criterio'] ) )
{
    if( $_GET['criterio'] != ' ' )
    {
        ...
        $cantidad = $productosDAO->getCantidadProductoPorCategoria( (int) $criterio ); // determina cuántos productos son con el filtro dado
        ...
        {            
            $productos = $productosDAO->getProductoPorCategoria( (int) $criterio, (int) $GLOBALS['inicio'], (int) TAMANIO ); 
        }
    }
}
    ...
    <body>
       <div class="wrapper">
        ...
        <div class="banner">
            ...
            <div class="ContainerTextoBanner"><div class="TextoBanner">
            <?php 
                if(isset($productos)){
                  if($productos != NULL) 
                    echo $productos[0]['nom']; 
        ...
        <div class="linkAzul">
            ...
            <a name="ancla" id="a"></a>
            <div class="acerca"><div class="acercaTexto"><br></div></div>
            <div class="lateral">
            <?php
                if(isset($categorias)){
                    foreach ($categorias as $valor) {                               
            ?>
                <li><a href="<?php echo 'productosporcategoria.php?criterio='.$valor['id']; ?>"><?php echo $valor['nom']; ?></a></li>              
            <?php                  
                }
              }
            ?>
            ...
            <div id="pagina">
                ...
                ?>
                                <li>
                                    <a href="productosporcategoria.php?criterio=<?php echo $_GET['criterio']; ?>&pagina=<?php echo $i; ?>#ancla">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                <?php 
                ...
                ?>      
                                <li class="next">
                                    <a href="productosporcategoria.php?criterio=<?php echo $_GET['criterio']; ?>&pagina=<?php echo $numeropaginas; ?>#ancla">
                                        Next &raquo;
                                    </a>
                                </li>
                <?php
                ...
                ?>
                            <li class="previous">
                                <a href="productosporcategoria.php?criterio=<?php echo $_GET['criterio']; ?>&pagina=<?php echo $prevpag; ?>#ancla">
                                    &laquo; Previous
                                </a>
                            </li>
                <?php
                ...
                ?>   
                                <li class="next">
                                    <a href="productosporcategoria.php?criterio=<?php echo $_GET['criterio']; ?>&pagina=<?php echo $nextpag; ?>#ancla">
                                        Next &raquo;
                                    </a>
                                </li>
                <?php
